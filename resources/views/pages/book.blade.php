...
@section('content')
                        ...
                        <div class="col-md-6 col-lg-4 mt-5 pb-5">
                            <div class="card m-auto  shadow-lg" style="width: 15rem;">
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title w-130px">{{ $book->title }}</h5>
                                    <p class="card-text"> {{ $book->authorFullName }}</p>
                                    <div class="position-absolute p-3 mb-5 w-75 fixed-bottom">
                                        @is_borrowed($book->is_borrowed)
                                        <a href="#" class="btn btn-sm btn-secondary w-75 ">Give back</a>
                                        @else
                                            <a href="#" class="btn btn-sm btn-secondary w-75 ">Borrow</a>
                                        @endif
                                    </div>
                                    <div class="position-absolute d-flex fixed-bottom p-3 mt-2">
                                        ...
                                        <a href="#" class="btn btn-sm btn-dark ml-2">Edit</a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    @include('components.add_book_modal')
